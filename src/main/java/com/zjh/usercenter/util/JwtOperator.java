package com.zjh.usercenter.util;
...
public class JwtOperator {
    ...
    public static void main(String[] args) {
        ...
        // 将我改成上面生成的token!!!
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1ODI5NDE1MjMsImV4cCI6MTU4NDE1MTEyM30.kTg9LntDMvoucF5db62bTj0K_5luaQUhDQqs_tPWD8U";

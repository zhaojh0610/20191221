...
import com.zjh.usercenter.auth.CheckLogin;
import com.zjh.usercenter.domain.dto.user.JwtTokenRespDTO;
import com.zjh.usercenter.domain.dto.user.LoginRespDTO;
import com.zjh.usercenter.domain.dto.user.UserLoginDTO;
import com.zjh.usercenter.domain.dto.user.UserRespDTO;
import com.zjh.usercenter.domain.entity.user.User;
import com.zjh.usercenter.service.user.UserService;
import com.zjh.usercenter.util.JwtOperator;
...
public class UserController {
    ...
    public String genToken() {
        ...
        userInfo.put("id", "1");
        userInfo.put("wxNickname", "zhaojh");
